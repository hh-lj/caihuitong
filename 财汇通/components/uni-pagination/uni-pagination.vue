<template>
	<view class="uni-pagination">
			...
			<view class="uni-pagination__btn" :class="currentIndex === 1 ? 'uni-pagination--disabled' : 'uni-pagination--enabled'"
			 ...
			 @click="clickLeft">
				<template v-if="showIcon===true || showIcon === 'true'">
					<uni-icons color="#333" size="20" type="arrowleft" />
				</template>
		...
		<view class="uni-pagination__num-current">
				<text class="uni-pagination__num-current-text" style="color:#FF504D">{{ currentIndex }}</text><text class="uni-pagination__num-current-text">/{{ maxPage || 0 }}</text>
			</view>
		</view>
	</view>
</template>
